...
<template>
  ...
  >
    ...
    <div
      class="mt-16 w-full max-w-4xl rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden transform transition hover:scale-[1.02] duration-300"
    >
